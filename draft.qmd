...
# Open-Source-KI {background-color="#1c2d3f"}
...
- immer häufiger sind auch **Persönlichkeitsrechte** tangiert
:::
::::
...
:::: columns
::: {.column width='60%'}
- Modelle werden in der Regel durch Schnittstellen für die Mensch-Maschine- oder Maschine-Maschine-Interaktion ergänzt
  - Beispiel: GPT-3.5/4 ist das Modell, ChatGPT die Anwendung
:::
...
## (5) Modelle evaluieren[^1]

[^1]: Der Begriff Evaluation als "Prüfung für den Einsatzzweck aus Sicht von Anwender\*innen" verstanden und von Validierung als "Prüfung der Performance aus Sicht von Entwickler\*innen" abgegrenzt.
...
- Anders als bei Open-Source-Software sind viele komplexe Komponenten an der Entwicklung von KI-Systemen beteiligt.
...
| | | |
|-|-----|-|
|2,3,4| [**Jupyter Notebook**](https://jupyter.org/) | Entwicklungsumgebung im Browser[^2] | 
...
<p class="legende">Legende: 1) Daten sammeln, 2) Daten aufbereiten, 3) Modelle trainieren, 4) Anwendungen entwickeln, 5) Modelle evaluieren </p>
