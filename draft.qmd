...
- Anschließend erfolgt eine weitere Stufe der Evaluation, oft durch Interaktion mit der Zielgruppe
:::
::: {.column width='29%'}
...
- Modelle brauchen Schnittstellen für die Mensch-Maschine- oder Maschine-Maschine-Interaktion
...
**Welche Tools fördern das Verständnis für KI in sozialen Settings?**

| | |
|-----|-|
| [**Label Studio**](https://labelstud.io/)    | (kollaborative) Bearbeitung von Trainingsdaten | 
| [**spaCy**](https://spacy.io/)          | Python-Bibliothek für Natural Language Processing (NLP) | 
| [**ml5.js**](https://ml5js.org/)          | ML-/DL-Modelle mit [p5.js](https://p5js.org/) im Browser zu nutzen. | 
| [**Teachable Machine**](https://teachablemachine.withgoogle.com/) | webbasiertes Tool, um Modelle zu trainieren. | 
| [**PoseBlocks**](https://playground.raise.mit.edu/create/)    | Scratch-basierte Umgebung für KI-Anwendungen | 
| [**Jan.ai**](https://www.jan.ai/)          | LLMs offline verwenden  | 
| [**Ollama**](https://ollama.com/)          | LLMs offline verwenden  | 
| [**Jupyter Notebook**](https://jupyter.org/) | Entwicklungsumgebung im Browser | 
| [**Gradio**](https://www.gradio.app/)          | Python-Bibliothek für interaktive KI-Interfaces | 
| [**Hugging Face**](https://huggingface.co/)    | Plattform für Daten, Modelle und Anwendungen | 
